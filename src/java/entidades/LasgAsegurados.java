...
public class LasgAsegurados implements Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ASEGURADOS_")
    @SequenceGenerator(name = "SEQ_ASEGURADOS_", sequenceName = "SEQ_ASEGURADOS", initialValue = 1, allocationSize = 1)
